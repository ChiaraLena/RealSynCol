...
class LiteMonoOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["SimCol", "RealSynCol", "C3VD"],
                                 default="RealSynCol")
        ...
        self.parser.add_argument("--name_custom_dataset",
                                 type=str,
                                 help="dataset to train on",
                                 default="RealSynCol",
                                 choices=["RealSynCol", "SimCol", "C3VD"])
        ...
        self.parser.add_argument("--eval_out_dir",
                                 ...
                                 type=str)
        self.parser.add_argument("--sequence_evaluate",
                                 type=str,
                                 help="name of the specific sequence to evaluate the pose")
        self.parser.add_argument("--post_process",
                                 help="if set will perform the flipping post processing "
                                      "from the original monodepth paper",
                                 action="store_true")
        self.parser.add_argument("--test_name",
                                 type=str,
                                 help="name of the specific test experiment")
